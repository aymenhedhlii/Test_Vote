<?php $__env->startSection('content'); ?>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="<?php echo e(route('reponses.reponse.store')); ?>" accept-charset="UTF-8" id="create_reponse_form" name="create_reponse_form" class="form-horizontal">
