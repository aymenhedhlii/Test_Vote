...
<a href="{{url('admin/routes')}}"><li class="form-control" name="Admin"> <b> Admin </b></li></a>  
</div><?php } elseif(auth()->user()->isAdmin == 0){?>
  <div class="panel-body">
<a href="{{url('admin/routes')}}"><li class="form-control" name="internaute"><b> User </b> </li></a>  
</div><?php }?>
...
<li> @if (auth()->user()->isAdmin == 1) <a  onclick="window.location.href='/questions/create'">Ajouter nouvelle question</a>
