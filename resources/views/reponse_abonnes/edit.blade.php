...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">{{ !empty($title) ? $title : 'Reponse Abonnes' }}</h4>
            </div>
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('reponse_abonnes.reponse_abonnes.update', $reponseAbonnes->id) }}" id="edit_reponse_abonnes_form" name="edit_reponse_abonnes_form" accept-charset="UTF-8" class="form-horizontal">
            {{ csrf_field() }}
